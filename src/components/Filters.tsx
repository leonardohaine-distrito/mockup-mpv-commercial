  ...
  return (
    <div className="flex flex-wrap items-center gap-4 p-4 border-b border-gray-200 bg-white">
      <div className="flex items-center gap-2">
        ...
        <Select onValueChange={onRegionalChange} value={selectedRegional}>
          ...
          <SelectContent>
            <SelectItem value="all">{t("filters.allCategories")}</SelectItem> {/* Add 'All' option for regional */}
      ...
      <div className="flex items-center gap-2">
        ...
        <Select onValueChange={onClientChange} value={selectedClient}>
          ...
          <SelectContent>
            <SelectItem value="all">{t("filters.allCategories")}</SelectItem> {/* Add 'All' option for client */}
